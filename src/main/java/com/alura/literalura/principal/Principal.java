...
public class Principal {
    ...
    private static final List<String> IDIOMAS_VALIDOS = List.of("es", "en", "fr", "pt");
    ...
    /**
     * Maneja la lógica de búsqueda de libros por título.
    ...
    private void buscarLibroPorTitulo(Scanner scanner) {
        ...
        try {
            ...
            if (librosDTO.isEmpty()) {
                ...
                boolean libroRegistrado = registrarLibroSiNoExiste(titulo, librosDTO);
                if (!libroRegistrado) {
    ...
    /**
     * Registra un libro si no existe en la base de datos.
     * @param titulo El título del libro a registrar.
     * @param librosDTO La lista de libros obtenidos de la API.
     * @return true si el libro fue registrado, false en caso contrario.
     */
    private boolean registrarLibroSiNoExiste(String titulo, List<LibroDTO> librosDTO) {
        for (LibroDTO libroDTO : librosDTO) {
            if (libroDTO.getTitulo().equalsIgnoreCase(titulo)) {
                ...
                if (libroExistente.isPresent()) {
                    ...
                    Libro libro = crearLibroDesdeDTO(libroDTO);
    ...
    /**
     * Crea un objeto Libro a partir de un LibroDTO.
     * @param libroDTO El objeto LibroDTO.
     * @return El objeto Libro creado.
     */
    private Libro crearLibroDesdeDTO(LibroDTO libroDTO) {
    ...
    private void listarLibrosRegistrados() {
        libroService.listarLibros().forEach(this::mostrarDetallesLibro);
    }
    ...
    private void listarAutoresRegistrados() {
        autorService.listarAutores().forEach(this::mostrarDetallesAutor);
    }
    ...
    private void listarAutoresVivosEnAno(Scanner scanner) {
        ...
        if (autoresVivos.isEmpty()) {
            ...
            autoresVivos.forEach(this::mostrarDetallesAutor);
        }
    }
    ...
    private void listarLibrosPorIdioma(Scanner scanner) {
        System.out.println("es= Español, en= Ingles, fr= Frances, pt= Portugues.");
        System.out.print("Ingrese el idioma: ");
        String idioma = scanner.nextLine();
        if (IDIOMAS_VALIDOS.contains(idioma.toLowerCase())) {
    ...
    /**
     * Muestra los detalles de un libro a partir de un LibroDTO.
     * @param libroDTO El objeto LibroDTO.
     */
